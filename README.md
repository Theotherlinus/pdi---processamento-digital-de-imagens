...
- **`ex_resolvidos 2026.1/`**:
  - **`exercicios/`**: Pasta com exercícios propostos e resolvidos.
    ...
    - **`Exercicio03/`**: Inclui imagens para processamento.
  - **`praticas/`**: Atividades práticas da disciplina.
    - **`pratica_01/`**: Primeira prática, com código em MATLAB.

## Pré-requisitos

- MATLAB ou Octave para executar os scripts .m.
...
3. Execute os arquivos .m no MATLAB.

Para dúvidas ou contribuições, entre em contato com o responsável pela disciplina.
